...
#ifdef WOLFENGINE_DEBUG
static void print_buffer(const char *desc, const unsigned char *buffer, size_t len)
{
    size_t i;
...
static int test_digest_sign(EVP_PKEY *pkey, ENGINE *e, unsigned char *data,
...
static int test_digest_verify(EVP_PKEY *pkey, ENGINE *e, unsigned char *data,
                             size_t len, const EVP_MD *md,
                             unsigned char *sig, size_t sigLen)
{
    int err;
...
static int test_pkey_sign(EVP_PKEY *pkey, ENGINE *e, unsigned char *hash,
...
static int test_pkey_verify(EVP_PKEY *pkey, ENGINE *e,
...
static int test_rsa_digest(ENGINE *e, void *data)
{
    int err;
    int res;
    EVP_PKEY *pkey = NULL;
...
static int test_rsa_pkey(ENGINE *e, void *data)
{
    int err;
    int res;
    EVP_PKEY *pkey = NULL;
